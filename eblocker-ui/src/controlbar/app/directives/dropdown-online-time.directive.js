 ...
 */
export default function DropdownOnlineTimeDirective($document, ControlbarService) {
    'ngInject';
    ...
    return {
        ...
        scope: {
            ...
            tooltip: '=',                   // all,
            profile: '=',                   // online time profile
            getContingentDay: '&',
            getContingentDisplayTime: '&',
            startUsage: '&',
            stopUsage: '&',
            isLoading: '='
        },
        templateUrl: 'app/directives/dropdown-online-time.directive.html',
        replace: true,
