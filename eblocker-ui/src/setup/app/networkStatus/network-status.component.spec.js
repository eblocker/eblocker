 ...
 */
/* jshint expr:true */
describe('Component: networkStatus', function() {
    ...
    var $componentController, $q, $rootScope, ctrl, mockNetworkService, mockLoggerService, mockNetworkStatus;
    ...
    beforeEach(angular.mock.module(function($provide, $translateProvider) {
        $provide.value('NetworkService', mockNetworkService);
    ...
    beforeEach(inject(function(_$componentController_, _$q_, _$rootScope_) {
        ...
        ctrl = $componentController('networkStatus', {}, {});
    }));
