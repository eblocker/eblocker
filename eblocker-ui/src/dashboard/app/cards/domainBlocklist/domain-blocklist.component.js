...
function DomainBlocklistController(logger, $q, $interval, DataService, CustomDomainFilterService,
    ...
    function updateBlocklist(domains) {
        logger.warn('Updating blocklist', domains);
        return CustomDomainFilterService.updateBlocklist(domains);
    }
}
