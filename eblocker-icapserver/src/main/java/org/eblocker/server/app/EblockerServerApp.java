...
import org.eblocker.server.http.controller.impl.WireGuardDashboardControllerImpl;
...
public class EblockerServerApp {
    ...
    private void doInjectRESTController() {
        ...
        injectController(WireGuardDashboardController.class, WireGuardDashboardControllerImpl.class);
