...
describe('App settings; Auth component controller', function() {
    beforeEach(angular.mock.module('template.settings.app'));
    beforeEach(angular.mock.module('eblocker.adminconsole'));

    let ctrl, $componentController, security, StateService;

    security = {
        isAuthenticated: function() {
            // TODO update for real testing ...
            return true;
        }
    };
    ...
    StateService = {
        ...
        getWorkflowParam: function() {},
        isStateValid: function() {
            return true;
        },
        clearWorkflow: function() {},
        isWorkflowStatePersistent: function() {
            return false;
        }
    };
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('authComponent', {}, {});
    }));
