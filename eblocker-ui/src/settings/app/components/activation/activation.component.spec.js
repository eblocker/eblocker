...
describe('App settings; Activation component controller', function() {
    beforeEach(angular.mock.module('template.settings.app'));
    beforeEach(angular.mock.module('eblocker.adminconsole'));

    let ctrl, $componentController, StateService, mockSettings;
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('activationComponent', {}, {});
    }));
