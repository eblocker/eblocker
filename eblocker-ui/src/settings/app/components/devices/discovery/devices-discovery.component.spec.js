...
describe('App settings; Devices-Discovery component controller', function() {
    beforeEach(angular.mock.module('template.settings.app'));
    beforeEach(angular.mock.module('eblocker.adminconsole'));

    let ctrl, $componentController, StateService, mockRegistrationService;
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('devicesDiscoveryComponent', {}, {});
    }));
