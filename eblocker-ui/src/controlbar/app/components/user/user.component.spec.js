...
/* jshint expr:true */
describe('App controlbar; Component: user', function() {
    ...
    var $componentController, $q, $rootScope, ctrl, mockLoggerService, mockDeviceService, mockUserService;
    ...
    mockUserService = {
        ...
        initializeUserService: function() {

        },
        savePin: function() {

        },
        setOperatingUser: function() {
        },
