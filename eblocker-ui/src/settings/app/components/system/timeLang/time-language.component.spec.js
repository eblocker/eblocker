...
describe('App settings; Time-Language component controller', function() {
    beforeEach(angular.mock.module('template.settings.app'));
    beforeEach(angular.mock.module('eblocker.adminconsole'));

    let ctrl, $componentController, mockStateService, mockSettingsService;
    ...
    mockSettingsService = {
        ...
        getSupportedLanguageList: function() {
            return [];
        },
    };
    ...
    beforeEach(angular.mock.module(function($provide, $translateProvider) {
        ...
        $provide.value('settings', mockSettingsService);
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('timeLanguageComponent', {}, {});
    }));
