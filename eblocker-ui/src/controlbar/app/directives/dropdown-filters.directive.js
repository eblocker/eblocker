 ...
 */
function controller(ConsoleService, $scope) {
    'ngInject';
    const vm = this;

    // should actually allow user to enable filters. But since we do not show the filter card at
    // the moment, we should navigate to settings instead.
    vm.handleClick = navigateToConsole;

    function navigateToConsole() {
        ConsoleService.goToConsole(false);
    }
}


export default function DropdownFiltersDirective($document, ControlbarService) {
    'ngInject';

    return {
        restrict: 'E',
        scope: {
            labelBlockGlobal: '=',      // tracker/ads specific
            labelAllowLocal: '=',       // tracker/ads specific
            labelBlocked: '=',
            allowLocallyCallback: '&',  // tracker/ads specific
            blockGloballyCallback: '&', // tracker/ads specific
            blockingVars: '=',          // tracker/ads specific
            blockedList: '=',           // tracker/ads specific
            dnsBlockings: '=',          // tracker/ads specific
            filterMode: '=',            // tracker/ads specific
            imageLabel: '=',            // all
            imageUrl: '=',              // all
            badgeNumber: '=',           // tracker/ads specific
            tooltip: '='                // all
        },
        templateUrl: 'app/directives/dropdown-filters.directive.html',
