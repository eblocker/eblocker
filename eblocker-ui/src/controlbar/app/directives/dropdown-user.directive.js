...
function Controller($scope, $translate) {
    ...
    const vm = this;
    vm.translatedTooltipParam = $translate.instant($scope.imageLabel);
}

export default function DropdownUserDirective($document, ControlbarService) {
    'ngInject';
    ...
    return {
        ...
        controllerAs: 'vm',
        scope: {
            assignedUser: '=',   // user specific
            operatingUser: '=',  // user specific
            users: '=',          // user specific
            options: '=',        // user specific (anon uses options object as well)
            label: '=',          // all
            imageLabel: '=',     // all
            imageUrl: '=',       // all
            closeDropdown: '=',  // used to close dropdown when dialog opens
            tooltip: '='         // all
        },
        templateUrl: 'app/directives/dropdown-user.directive.html',
        replace: true,
