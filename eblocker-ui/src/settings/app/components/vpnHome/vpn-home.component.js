 ...
 */
export default {
    templateUrl: 'app/components/vpnHome/vpn-home.component.html',
    controller: Controller,
    controllerAs: 'vm'
};

function Controller(logger, StateService, $state, STATES) {
    'ngInject';
    'use strict';
    ...
    vm.subStates = StateService.getSubStates(STATES.VPN_HOME_STATE);
