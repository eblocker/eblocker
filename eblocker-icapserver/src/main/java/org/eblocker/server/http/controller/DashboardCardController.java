...
public interface DashboardCardController {
    ...
    List<UiCard> getDashboardCards(Request request, Response response);

    void setDashboardColumnsView(Request request, Response response);

    DashboardColumnsView getDashboardColumnsView(Request request, Response response);
