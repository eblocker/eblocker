...
import org.eblocker.server.http.controller.impl.WireGuardControllerImpl;
import org.eblocker.server.http.controller.impl.WireGuardMobileControllerImpl;
...
public class EblockerServerApp {
    ...
    private void doInjectRESTController() {
        ...
        injectController(WireGuardController.class, WireGuardControllerImpl.class);
        injectController(WireGuardMobileController.class, WireGuardMobileControllerImpl.class);
