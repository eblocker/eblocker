...
public class FilterStatisticsUpdateScheduler extends FixedRateScheduler {
    ...
    @Inject
    public FilterStatisticsUpdateScheduler(@Named("executor.filter.stats.update.startupDelay") Long delay,
                                           @Named("executor.filter.stats.update.fixedRate") Long rate,
                                           FilterStatisticsService filterStatisticsService) {
        super(filterStatisticsService::updateCounters, delay, rate);
    }
}
