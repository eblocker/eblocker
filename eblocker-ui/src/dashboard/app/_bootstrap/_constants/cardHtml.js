...
/* jshint ignore:start */
export default {
    ANONYMIZATION: '<dashboard-anonymization card-id="<CARD_ID_PLACEHOLDER>"></dashboard-anonymization>',
    ...
    MESSAGE: '<dashboard-message card-id="<CARD_ID_PLACEHOLDER>"></dashboard-message>',
    MOBILE: '<dashboard-mobile card-id="<CARD_ID_PLACEHOLDER>"></dashboard-mobile>',
    ONLINE_TIME: '<dashboard-online-time card-id="<CARD_ID_PLACEHOLDER>"></dashboard-online-time>',
    PAUSE: '<dashboard-pause card-id="<CARD_ID_PLACEHOLDER>"></dashboard-pause>',
