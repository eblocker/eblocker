...
public class MobileConnectionCheckTaskTest {
    ...
    public void setUp() {
        ...
        Mockito.when(wireGuardMobileService.getWireGuardMappedPort()).thenReturn(PORT);
    ...
    public void testConnectionTestDifferentMappedPortSuccess() throws Exception {
        ...
        Mockito.when(wireGuardMobileService.getWireGuardMappedPort()).thenReturn(routerPort);
