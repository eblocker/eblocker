...
public class DnsStatisticsScheduler extends FixedRateScheduler {
    ...
    @Inject
    public DnsStatisticsScheduler(@Named("executor.dns.stats.update.startupDelay") Long delay,
                                  @Named("executor.dns.stats.update.fixedRate") Long rate,
                                  DnsStatisticsService dnsStatisticsService) {
        super(dnsStatisticsService::update, delay, rate);
    }
}
