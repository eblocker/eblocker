...
public class WireGuardControllerImpl implements WireGuardController {
    ...
    @Override
    public VpnConfigurationViewModel getProfileConfig(Request request, Response response) {
        try {
    ...
    @Override
    public VpnConfigurationViewModel uploadProfileConfig(Request request, Response response) {
        try {
    ...
    @Override
    public VpnConfigurationViewModel uploadProfileConfigOption(Request request, Response response) {
    ...
    private VpnConfigurationViewModel mapConfiguration(WireGuardConfiguration configuration) {
        VpnConfigurationViewModel model = new VpnConfigurationViewModel();
        List<VpnConfigurationViewModel.ConfigLine> activeOptions = new ArrayList<>();
    ...
    private void addJoinedLine(List<VpnConfigurationViewModel.ConfigLine> lines, int[] lineNumber,
    ...
    private void addLine(List<VpnConfigurationViewModel.ConfigLine> lines, int[] lineNumber, String value) {
        VpnConfigurationViewModel.ConfigLine line = new VpnConfigurationViewModel.ConfigLine();
        line.source = "user";
