...
public class OpenVpnControllerImplTest {
    private AnonymousService anonymousService;
    private WireGuardService wireGuardService;
    private SessionStore sessionStore;
    private DeviceService deviceService;
    private OpenVpnControllerImpl controller;
    ...
    public void setUp() {
        ...
        controller = new OpenVpnControllerImpl(anonymousService, wireGuardService, sessionStore, deviceService);
    }
    ...
    public void uploadProfileConfigOptionRejectsOpenVpnInlineFiles() {
