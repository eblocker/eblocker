...
/**
 * VPN provider profile for WireGuard client instances.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class WireGuardProfile implements VpnProfile {
    private Integer id;
    private String name;
    ...
    public WireGuardProfile(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof WireGuardProfile)) {
            return false;
        }
        WireGuardProfile other = (WireGuardProfile) that;
