...
public class PatternBlockerUtilsTest {
    ...
    public void setUp() {
        ...
        Mockito.when(session.getDeviceId()).thenReturn("device:000000000000");
        ...
        patternBlockerUtils = new PatternBlockerUtils(true, blockedDomainLog, filterStatisticsService);
    }
