...
public class UserModuleOld {
    ...
    @JsonCreator
    public UserModuleOld(@JsonProperty("id") Integer id,
                         ...
                         @JsonProperty("dashboardCards") List<DashboardCard> dashboardCards,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        UserModuleOld other = (UserModuleOld) obj;
