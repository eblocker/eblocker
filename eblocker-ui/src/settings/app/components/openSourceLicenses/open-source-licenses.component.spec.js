...
describe('App settings; OpenSourceLicenses controller', function() {
    beforeEach(angular.mock.module('template.settings.app'));
    beforeEach(angular.mock.module('eblocker.adminconsole'));

    let ctrl, $componentController, StateService, mockSecurity;
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('openSourceLicensesComponent', {}, {});
    }));
