...
public class CertificateExpirationMessageProvider extends AbstractMessageProvider {
    ...
    @Inject
    public CertificateExpirationMessageProvider() {
        String MESSAGE_CERTIFICATE_EXPIRATION_TITLE = "MESSAGE_CERTIFICATE_EXPIRATION_TITLE";
        String MESSAGE_CERTIFICATE_EXPIRATION_CONTENT = "MESSAGE_CERTIFICATE_EXPIRATION_CONTENT";
        String MESSAGE_CERTIFICATE_EXPIRATION_LABEL = "MESSAGE_CERTIFICATE_EXPIRATION_LABEL";
    ...
    protected Set<Integer> getMessageIds() {
        return Collections.singleton(MessageProviderMessageId.MESSAGE_CERTIFICATE_EXPIRATION_WARNING.getId());
    }
    ...
    protected void doUpdate(Map<Integer, MessageContainer> messageContainers) {
        ...
        if (!messageContainers.containsKey(MessageProviderMessageId.MESSAGE_CERTIFICATE_EXPIRATION_WARNING.getId())) {
            ...
            messageContainers.put(MessageProviderMessageId.MESSAGE_CERTIFICATE_EXPIRATION_WARNING.getId(), messageContainer);
        }
    }
