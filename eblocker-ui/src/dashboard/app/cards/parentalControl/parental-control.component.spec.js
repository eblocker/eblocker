...
describe('Component: dashboardParentalControl', function() {
    ...
    beforeEach(angular.mock.module(function($provide) {
        $provide.value('onlineTime', {});
        $provide.value('LocalTimestampService', {});
    ...
    beforeEach(inject(function(_$componentController_) {
        ...
        ctrl = $componentController('dashboardParentalControl', {}, {});
    }));

    describe('dashboardParentalControl', function() {
