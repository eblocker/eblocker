 ...
 */
export default function DropdownAnonDirective($document, ControlbarService) {
    'ngInject';

    return {
        restrict: 'E',
        scope: {
            options: '=',        // anon specific (user uses options object as well)
            profiles: '=',       // anon specific
            activeProfile: '=',  // anon specific
            label: '=',          // all
            imageLabel: '=',     // all
            imageUrl: '=',       // all
        ...
        templateUrl: 'app/directives/dropdown-anon.directive.html',
        replace: true,
