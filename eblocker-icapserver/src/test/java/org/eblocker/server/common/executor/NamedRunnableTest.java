...
public class NamedRunnableTest {
    ...
    private NamedRunnable namedRunnable;

    @Before
    public void setUp() {
        delegateRunnable = Mockito.mock(Runnable.class);
        namedRunnable = new NamedRunnable(NAME, delegateRunnable);
    }

    @Test
    public void getName() {
        Assert.assertEquals(NAME, namedRunnable.getName());
    }
